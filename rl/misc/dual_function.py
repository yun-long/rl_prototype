...
# # ===================== REPS dual function version 1, for discrete case, update param_v only ===================
...
def f_dual_v0(A, features_diff, sa_n, eta, alpha):
    ...
    def dual(inputs):
        ...
        dg_lamda = -np.average(w, weights=sa_n) + 1.0
        return g, np.r_[dg_v, dg_lamda]
    return dual

def optimize_fdual_fn(rewards, features_diff, sa_n, eta, alpha, rnd):
